...
//#define PMSM_CHOPPER_PERIOD 9000 // 8 KHz PWM
//#define PMSM_CHOPPER_PERIOD 4500 // 16 KHz PWM
#define PMSM_CHOPPER_PERIOD 2250 // 32 KHz PWM
//#define PMSM_CHOPPER_PERIOD 1125 // 64 KHz PWM
...
uint16_t get_PMSM_Speed_prev(void);
